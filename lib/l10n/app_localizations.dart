...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Team meeting in Cairo'**
  String get desc_meeting;

  /// No description provided for @desc_exhibition.
  ///
  /// In en, this message translates to:
  /// **'Art exhibition downtown'**
  String get desc_exhibition;

  /// No description provided for @desc_sport.
  ///
  /// In en, this message translates to:
